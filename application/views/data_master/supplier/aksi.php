...
function edit_supplier(supplier_id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('supplier/edit/')?>/" + supplier_id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('[name="supplier_nama"]').val(data.supplier_nama);
            $('[name="supplier_alamat"]').val(data.supplier_alamat);
            $('[name="supplier_telp"]').val(data.supplier_telp);
...
function delete_supplier(supplier_id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('supplier/delete')?>/"+ supplier_id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
